...
function App() {
  ...
  return (
    <main className="min-h-screen bg-monolith-bg text-monolith-txt flex items-center justify-center p-6 md:p-12 relative overflow-hidden selection:bg-monolith-accent selection:text-black">
